...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    MAMUTINIUM("mamutinium", 50, new int[]{5, 9, 10, 6}, 20, SoundEvents.ARMOR_EQUIP_NETHERITE,
            5.0F, 0.2F, () -> Ingredient.of(ModItems.Mamutinium.get()));
    ...
    public String getName() {
        return MamutMod.MOD_ID + ":" + this.name;
    }
